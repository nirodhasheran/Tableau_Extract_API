...
public final class TableauSDKSample{
     ...
     */
    public static Extract createOrOpenExtract(
        String filename
    )
    {
        ...
        try {
            ...
            if ( !extract.hasTable( "Extract" ) ) {
                ...
                schema.addColumn( "City",     Type.CHAR_STRING );
                schema.addColumn( "State",    Type.CHAR_STRING );
                schema.addColumn( "Latitude", Type.DOUBLE );
                schema.addColumn( "Longitude",Type.DOUBLE );
                schema.addColumn( "Sales", 	  Type.DOUBLE );
     ...
     */
    public static void publishExtract(
        String  filename,
        String  projectName,
    ...
    public static void main( String[] arguments) {
        ...
        if ( options.containsKey("build" ) ) {
            try {
                ...
                Extract extract = createOrOpenExtract( options.get( "filename" ));
                value=mapper.readValue(new File("C:\\Users\\pcN\\Intern\\samples\\geoCode.json"),Location[].class);
                location.populateExtract(extract,value);
