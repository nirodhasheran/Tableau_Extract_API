...
/// Adds a column to the table definition. The order in which columns are added specifies their column number. String columns are defined with the current default collation. Note: A couple of phrases are reserved in Tableau, ':Measure Names', 'Multiple Values', and 'Number of Records'. Please avoid using them as the column names.
/// @param name The name of the column to add. Note: please avoid using reserved phrases ':Measure Names', 'Multiple Values', and 'Number of Records' as the column names.
